...
Bevor wir uns mit der Funktionsweise von Java auseinandersetzen, schreiben wir einfach einmal unser erstes Programm. Wir öffnen dazu [*Eclipse*](../tools/#eclipse) und erstellen uns eine Klasse `HelloFIW`. Dazu 
